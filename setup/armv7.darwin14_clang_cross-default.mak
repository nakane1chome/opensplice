...
SDK_ROOT=${XCODE_PATH}/Contents///Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS.sdk/

FRAMEWORKS=\
	Foundation \
	UIKit

CLANG_PATH=${XCODE_PATH}/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/
...
CLANG_FLAGS=\
          ...
          -arch armv7 \
          -march=armv7 \
        -I${OSPL_HOME}/src/abstraction/os/darwin14-ios/include \
		-isysroot ${SDK_ROOT}  \
...
CFLAGS_OPT       = ${CLANG_FLAGS} -O4 -DNDEBUG
CFLAGS_DEBUG     = ${CLANG_FLAGS} -g -D_TYPECHECK_
CFLAGS_STRICT	 = ${CLANG_FLAGS} -Wall -W -Wno-deprecated-declarations
CFLAGS_XSTRICT   = ${CLANG_FLAGS} -Wconversion
CFLAGS_PERMISSIVE= ${CLANG_FLAGS} -Wno-unneeded-internal-declaration -Wno-unused-function -Wno-sign-compare
...
# Set linker options
LDFLAGS		 = ${CLANG_LDFLAGS} -L$(SPLICE_LIBRARY_PATH) $(CFLAGS) # -Wl,-flat_namespace

# Identify linker options for building shared libraries
SHLDFLAGS	 = ${CLANG_LDFLAGS} -dynamiclib -undefined error
